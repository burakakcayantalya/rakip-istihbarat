...
# Her 10 dakikada bir küme sayfalarını analiz et
# ============================================
...
from ai_helper.models import AIHelperProject, AIHelperCluster, add_log
from ai_helper.page_analyzer import PageAnalyzer
from core.database import SessionLocal


async def periodic_analyze_clusters():
    """Her 10 dakikada bir çalışacak: Tüm aktif projelerin kümelerini analiz et"""
    db = SessionLocal()
    try:
